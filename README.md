...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aioredis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6942&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aioredis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aioredis` can be installed with:

```
conda install aioredis
```

It is possible to list all of the versions of `aioredis` available on your platform with:
